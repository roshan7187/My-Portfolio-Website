...
const CONFIG = {
  ...
  projects: [
    {
      title: "News Portal",
      desc: "Real-time news aggregator with admin dashboard.",
      tech: "React / Node.js",
      radius: 2.5,
      speed: 0.2,
      color: 0xff4444,
    ...
    {
      title: "E-Commerce",
      desc: "Full-stack shopping platform with Stripe integration.",
      tech: "Next.js / Stripe",
      radius: 3.5,
      speed: 0.15,
      color: 0x44ff44,
    ...
    },
    {
      ...
      desc: " IoT device monitoring system on AWS.",
      tech: "IoT / AWS",
      radius: 4.5,
      speed: 0.1,
      color: 0x4444ff,
    ...
    {
      title: "Debatify",
      desc: "Gamified debating platform with live voting.",
    ...
    {
      title: "2048 App",
      desc: "Optimized clone of the popular puzzle game.",
      tech: "React / Logic",
      radius: 6.5,
      speed: 0.05,
      color: 0xff44ff,
    ...
    {
      title: "AI Chatbot",
      desc: "NLP-based customer support agent.",
    ...
    {
      title: "Crypto Dash",
      desc: "Real-time cryptocurrency tracker.",
      tech: "Vue.js / API",
      radius: 8.5,
      speed: 0.09,
      color: 0xffaa00,
    ...
    {
      title: "Task Master",
      desc: "Productivity app with gamification.",
      ...
      if (intersects.length > 0) {
        ...
        if (object) {
          ...
          if (state.hoveredPlanet !== planet) {
            if (state.hoveredPlanet) {
              // Reset previous hovered planet's scale
              gsap.to(state.hoveredPlanet.scale, {
                x: 1,
                y: 1,
                z: 1,
                duration: 0.3,
            ...
            document.getElementById("tooltip-desc").innerText =
              planet.userData.desc;
            document.getElementById("tooltip-tech").innerText =
              planet.userData.tech;
...
const initScrollAnimations = (camera, mesh) => {
  ...
  ScrollTrigger.create({
    ...
    onEnter: () => {
      if (state.atomicSystem) state.atomicSystem.visible = true;
    },
    onLeave: () => {
      if (state.atomicSystem) state.atomicSystem.visible = false;
    },
    onEnterBack: () => {
      if (state.atomicSystem) state.atomicSystem.visible = true;
    },
